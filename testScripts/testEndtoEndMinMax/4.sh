#!/bin/bash
cd ../../bin
(java quoridorServer.Server 3939 7 &) > ../testScripts/testEndtoEnd2Player/server1Test.txt
(java quoridorServer.Server 3838 8 &) > ../testScripts/testEndtoEnd2Player/server2Test.txt
